 ...
 * @brief       Critical code sections Configuration
 * @addtogroup  mem_cfg
 * @brief       Konfiguracija kriticnih sekcija koda
 *********************************************************************//** @{ */

#ifndef CRITICAL_CONFIG_H_
#define CRITICAL_CONFIG_H_
...
/** @endcond *//** @} *//******************************************************
 * END of critical_config.h
 ******************************************************************************/
#endif /* CRITICAL_CONFIG_H_ */
