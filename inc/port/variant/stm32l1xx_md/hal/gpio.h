 ...
 * @author      nesa
 *
 * @brief       Interfejs za GPIO modul STM32L1xx Medium Density serija, port
 *              klasa: varijanta.
 *
 * ------------------------------------------------------------------------------------------------
 *
...
/*-------------------------------------------------------------------------------------------*//**
 * @name        Promenljive za STM32L1xx MD seriju
 * @{ *//*---------------------------------------------------------------------------------------*/
 ...
 *              predaje funkcijama.
 *
 * @note		Kada HAL postane nezavisan od STM biblioteka, ovaj niz ce se
 * 				uklonititi.
 */
 /*-----------------------------------------------------------------------------------------------*/
extern const GPIO_TypeDef * HAL_GPIO_portLkUp[];
 ...
 */
/*-----------------------------------------------------------------------------------------------*/
extern const uint32_t HAL_GPIO_AHBPeriphLkUp[];
