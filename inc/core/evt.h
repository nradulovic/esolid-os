 ...
 *
 * @brief       Interfejs Event Object modula.
 *
 * ------------------------------------------------------------------------------------------------
 *
 * @addtogroup  evt_intf
 ...
 *
 *              Ukoliko je ovaj bit postavljen na jedinicu, dati dogadjaj je
 ...
 *
 *              Konstanta se koristi prilikom debag procesa kako bi funkcije
...
/*-----------------------------------------------------------------------------------------------*/
/**
 * @brief       Tipova predefinisanih dogadjaja.
 */
/*-----------------------------------------------------------------------------------------------*/
enum esEvtType {
/**
 ...
 *
 *              Ovaj tip dogadjaja se automatski specificira prilikom pozivanja
 ...
 *
 *              Ovaj signal se salje nakon povratne vrednosti @ref RETN_NOEX.
 */
    SIG_NOEX,
 ...
 *
 *              Dogadjaj sadrzi listu aktivnih EPA objekata u sistemu. Najcesce
 ...
 *
 *              Dogadjaj sadrzi informacije o trazenom aktivnom EPA objektu u
 ...
 *
 *              Nakon ovog identifikatora korisnik definise svoje, aplikacione
 ...
 *
 *              Podesavanje tipa se vrsi pomocu: @ref OPT_EVT_ID_T.
 */
    esEvtId_T       id;
 ...
 *
 *              Interni podaci dogadjaja su obavezni podaci u zaglavlju
...
/** @} *//*--------------------------------------------------------------------------------------*/
/*-------------------------------------------------------------------------------------------*//**
 * @name        Transport dogadjaja kada se koristi kernel
 * @{ *//*---------------------------------------------------------------------------------------*/
